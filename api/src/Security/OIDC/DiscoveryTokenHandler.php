 ...
 */
final class DiscoveryTokenHandler implements AccessTokenHandlerInterface
{
    use OidcTrait;
    ...
    public function getUserBadgeFrom(string $accessToken): UserBadge
    {
        try {
            $oidcConfiguration = json_decode($this->cache->get('oidc.configuration', function (ItemInterface $item): string {
                ...
                $response = $this->securityAuthorizationClient->request('GET', 'https://sso.itstoni.com/application/o/purus-dev/.well-known/openid-configuration');
